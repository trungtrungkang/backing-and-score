    ...
    <div className="min-h-screen bg-white dark:bg-[#0E0E11] text-zinc-900 dark:text-zinc-100 flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10 my-8">
        ...
        <div className="flex flex-col items-center justify-center mb-8">
          ...
          <p className="text-zinc-500 dark:text-zinc-400">Join Backing & Score today</p>
        </div>
        ...
        <div className="bg-white/80 dark:bg-zinc-900/60 backdrop-blur-xl border border-zinc-200 dark:border-white/10 rounded-3xl p-8 shadow-2xl dark:shadow-black/50">
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            ...
            <div className="relative flex items-center py-2">
              ...
              <span className="flex-shrink-0 mx-4 text-zinc-400 text-sm">or sign up with email</span>
              <div className="flex-grow border-t border-zinc-200 dark:border-white/10"></div>
            </div>

            <div className="space-y-1.5">
              <label className="text-sm font-medium text-zinc-700 dark:text-zinc-300 ml-1">Name <span className="text-zinc-400 font-normal">(optional)</span></label>
            ...
            <div className="space-y-1.5">
              <label className="text-sm font-medium text-zinc-700 dark:text-zinc-300 ml-1">Email <span className="text-red-500">*</span></label>
              <div className="relative">
            ...
            <div className="space-y-1.5">
              <label className="text-sm font-medium text-zinc-700 dark:text-zinc-300 ml-1">Password <span className="text-red-500">*</span></label>
              <div className="relative">
