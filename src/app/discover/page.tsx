      ...
      <div className="w-full max-w-[1200px] z-10 relative">
        ...
        <header className="mb-12 flex justify-center w-full">
          <div className="flex items-center gap-4 w-full max-w-2xl">
            <div className="relative w-full">
              <Input 
                placeholder="Search for songs, composers, styles..." 
        ...
        {loading ? (
          <div className="flex flex-col items-center gap-4 py-20">
            ...
            <p className="text-zinc-500 text-sm font-medium">Loading scores...</p>
          </div>
              ...
              >
                ...
                <div className="p-4 flex-1 flex flex-col relative w-full pointer-events-none">
                  ...
                  <p className="text-[14px] text-zinc-400 line-clamp-1 mb-4">
                    {p.creatorEmail ? p.creatorEmail.split('@')[0] : 'Community Composer'}
                  </p>
                  ...
                  <div className="flex items-start justify-between mb-4 gap-2">
                    <div className="flex items-center gap-1.5 flex-wrap flex-1">
                      {displayTags.length > 0 ? displayTags.map(tag => (
                        ...
                        <span className="text-[12px] text-zinc-400 dark:text-zinc-600 font-medium">No tags</span>
                      )}
                      {remainingCount > 0 && (
