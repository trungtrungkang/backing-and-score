...
import { Music4, Mic2, Layers, PlaySquare, ArrowRight, Play, SlidersHorizontal, AudioWaveform, Sparkles, Moon, Smartphone, Pause } from "lucide-react";
    ...
    <div className="min-h-screen bg-background dark:bg-[#0E0E11] text-foreground dark:text-white selection:bg-[#C8A856]/30 overflow-hidden font-sans">
      ...
      <main className="relative pt-32 pb-24 md:pt-48 md:pb-32 px-6 lg:px-12 flex flex-col items-center text-center">
        ...
        <div className="relative z-10 max-w-5xl w-full flex flex-col items-center animate-in fade-in slide-in-from-bottom-8 duration-1000">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-white/10 text-sm font-bold text-zinc-700 dark:text-zinc-300 mb-8 shadow-sm backdrop-blur-md">
            ...
            Public Beta 2.0 • The New Way to Play
          </div>
          ...
          <p className="text-lg md:text-2xl text-zinc-600 dark:text-zinc-400 font-medium max-w-3xl mb-12 leading-relaxed">
            Stop playing alone. <strong>Backing & Score</strong> syncs professional Multi-Track Stems with interactive MusicXML sheet music. Mute the guitar, follow the magic playhead, and play along with a real studio band.
          </p>
          ...
          <div className="w-full aspect-[16/9] md:aspect-[21/9] bg-zinc-100/80 dark:bg-black/60 rounded-t-3xl border-t border-x border-zinc-200 dark:border-white/10 shadow-[0_-20px_80px_rgba(0,0,0,0.1)] dark:shadow-[0_-20px_80px_rgba(0,0,0,0.5)] overflow-hidden flex flex-col transform rotate-x-[5deg] transition-transform hover:rotate-x-[2deg] duration-700 backdrop-blur-xl">
            ...
            <div className="flex-1 flex">
               ...
               <div className="w-1/4 hidden md:flex border-r border-zinc-200 dark:border-white/5 flex-col p-4 gap-3 bg-zinc-50/50 dark:bg-zinc-950/50">
                 {[1,2,3,4].map(i => (
                   <div key={i} className="w-full h-12 bg-white dark:bg-zinc-900 rounded-lg border border-zinc-200 dark:border-white/5 p-2 flex items-center gap-2">
                     <div className="w-6 h-6 rounded bg-[#C8A856]/20 flex items-center justify-center"><SlidersHorizontal className="w-3 h-3 text-[#C8A856]" /></div>
               ...
               <div className="flex-1 p-6 md:p-10 relative bg-white dark:bg-[#151515] flex flex-col justify-center items-center gap-12 overflow-hidden">
                 {/* Fake playhead */}
                 <div className="absolute top-0 bottom-0 left-1/3 w-0.5 bg-[#C8A856] shadow-[0_0_10px_#C8A856] z-10"></div>
                 {/* Fake staves */}
                 {[1,2,3].map(i => (
                   <div key={i} className="w-full max-w-2xl h-12 border-y border-black/10 dark:border-white/10 flex items-center justify-between px-8 relative opacity-60">
                     ...
                     <div className="w-2.5 h-2.5 rounded-full bg-[#C8A856] absolute left-1/3 top-2/4 scale-125 shadow-[0_0_15px_#C8A856]"><div className="w-0.5 h-6 bg-[#C8A856] absolute bottom-1 right-0"></div></div>
                 ...
                 <div className="absolute -bottom-20 left-1/3 w-[300px] h-[150px] bg-[#C8A856]/20 blur-[60px]"></div>
               </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto flex flex-col gap-32">
          ...
          <div className="flex flex-col md:flex-row items-center gap-12 lg:gap-20">
            <div className="w-full md:w-1/2 order-2 md:order-1">
              <div className="aspect-square bg-gradient-to-tr from-zinc-200 to-zinc-100 dark:from-zinc-900 dark:to-zinc-800 rounded-3xl p-8 relative overflow-hidden flex items-center justify-center border border-zinc-200 dark:border-white/5 shadow-2xl shadow-black/5 dark:shadow-none transition-transform hover:-translate-y-2 duration-500">
                 <div className="absolute inset-0 opacity-20 dark:opacity-40 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-blue-500/40 to-transparent"></div>
                 <div className="w-4/5 bg-white dark:bg-zinc-950 rounded-2xl shadow-2xl border border-zinc-200 dark:border-zinc-800 p-6 flex flex-col gap-4 relative z-10">
                   ...
                   {[
                     { name: "Rhythm Drums", vol: 80, active: true },
                     { name: "Lead Guitar", vol: 0, active: false }, // muted
                     { name: "Bass", vol: 60, active: true },
                   ].map(trk => (
                     <div key={trk.name} className={`flex items-center gap-3 p-2 rounded border ${trk.active ? 'bg-zinc-50 dark:bg-zinc-900 border-zinc-200 dark:border-zinc-800' : 'bg-red-50 dark:bg-red-950/30 border-red-200 dark:border-red-900/50'}`}>
                       ...
                       <div className={`w-1/3 h-1.5 rounded-full ${trk.active ? 'bg-blue-500' : 'bg-zinc-300 dark:bg-zinc-700'}`}></div>
                     </div>
                   ))}
                 </div>
              </div>
            ...
            <div className="w-full md:w-1/2 order-1 md:order-2 flex flex-col items-start text-left">
              ...
              <p className="text-lg text-zinc-600 dark:text-zinc-400 leading-relaxed mb-8">
                Every song is a multi-track recording. Want to practice the Piano part? Just mute the Piano stem to isolate the band, and you become the star player. You have full control over the studio mix.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-center gap-12 lg:gap-20">
            <div className="w-full md:w-1/2 flex flex-col items-start text-left">
              <div className="w-12 h-12 rounded-2xl bg-amber-100 dark:bg-[#C8A856]/10 flex items-center justify-center mb-6 border border-amber-200 dark:border-[#C8A856]/20">
                <Sparkles className="w-6 h-6 text-amber-600 dark:text-[#C8A856]" />
              </div>
              <h2 className="text-3xl md:text-5xl font-black mb-6 text-zinc-900 dark:text-white">Magic Sync <br/>Playhead.</h2>
              <p className="text-lg text-zinc-600 dark:text-zinc-400 leading-relaxed mb-8">
                Our proprietary Timemap Engine continuously links the pure audio wavelengths to the logical beats of the MusicXML score. The notes light up exactly as the band plays them—even through tempo changes and fermatas.
              </p>
            </div>
            <div className="w-full md:w-1/2">
              <div className="aspect-square bg-gradient-to-bl from-zinc-200 to-zinc-100 dark:from-zinc-900 dark:to-zinc-800 rounded-3xl p-8 relative overflow-hidden flex items-center justify-center border border-zinc-200 dark:border-white/5 shadow-2xl shadow-black/5 dark:shadow-none transition-transform hover:-translate-y-2 duration-500">
                <div className="absolute inset-0 opacity-20 dark:opacity-40 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-amber-500/30 to-transparent"></div>
                {/* Abstract Score Sync */}
                <div className="w-full h-3/4 flex flex-col justify-center relative z-10">
                  <div className="absolute top-0 bottom-0 left-1/2 w-0.5 bg-[#C8A856] shadow-[0_0_15px_#C8A856]"></div>
                  <div className="flex justify-between items-center w-full px-4 mb-8 opacity-50">
                    <Music4 className="w-8 h-8 text-zinc-800 dark:text-white" />
                    <Music4 className="w-8 h-8 text-zinc-800 dark:text-white" />
                  </div>
                  <div className="flex justify-between items-center w-full px-4 relative">
                    <div className="w-10 h-10 rounded-full border-4 border-zinc-800 dark:border-white"></div>
                    <div className="w-12 h-12 rounded-full border-4 border-[#C8A856] bg-[#C8A856] shadow-[0_0_20px_#C8A856] scale-125 z-20 transition-all"></div>
                    <div className="w-10 h-10 rounded-full border-4 border-zinc-800 dark:border-white"></div>
                  </div>
                </div>
              </div>
          ...
          <div className="flex flex-col md:flex-row items-center gap-12 lg:gap-20">
            <div className="w-full md:w-1/2 order-2 md:order-1">
              <div className="aspect-square bg-[#0E0E11] rounded-3xl p-8 relative overflow-hidden flex items-center justify-center border border-zinc-800 shadow-2xl shadow-black transition-transform hover:-translate-y-2 duration-500">
                 <div className="absolute inset-0 opacity-30 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-purple-500/40 to-transparent"></div>
                 <div className="w-[85%] bg-black rounded-lg border border-zinc-800 p-6 flex flex-col items-center gap-6 relative z-10 shadow-2xl">
                   <div className="w-full flex justify-between">
                     <Moon className="w-5 h-5 text-purple-400" />
                     <Smartphone className="w-5 h-5 text-zinc-500" />
                   </div>
                   <div className="w-24 h-24 rounded-full border-[6px] border-purple-500 flex items-center justify-center glow-purple">
                     <span className="text-white text-2xl font-black">120</span>
                   </div>
                   <div className="flex gap-4">
                     <div className="w-16 h-16 rounded-full bg-zinc-900 border border-zinc-700 flex items-center justify-center"><ArrowRight className="w-6 h-6 text-white" /></div>
                     <div className="w-16 h-16 rounded-full bg-purple-600 flex items-center justify-center"><Pause className="w-6 h-6 text-white" /></div>
                   </div>
                 </div>
              </div>
            </div>
            <div className="w-full md:w-1/2 order-1 md:order-2 flex flex-col items-start text-left">
              ...
              <h2 className="text-3xl md:text-5xl font-black mb-6 text-zinc-900 dark:text-white">Live Performance.</h2>
              <p className="text-lg text-zinc-600 dark:text-zinc-400 leading-relaxed mb-8">
                Take it to the stage. The dedicated iPad-ready <strong>Play Mode</strong> features a distraction-free Dark UI, giant finger-friendly touch targets, Setlists, and an auto-scrolling engine that flips the pages for you.
              </p>
            </div>
          </div>
      ...
      <section className="relative z-20 py-32 px-6">
        <div className="max-w-5xl mx-auto bg-gradient-to-br from-zinc-900 to-black dark:from-[#15151A] dark:to-black rounded-[3rem] p-12 md:p-20 text-center border border-zinc-800 shadow-2xl relative overflow-hidden flex flex-col items-center">
          ...
          <p className="text-xl text-zinc-400 mb-12 max-w-2xl relative z-10 font-medium">Join the community of musicians practicing and performing with real multitrack studio stems.</p>
          <Link href="/dashboard" className="relative z-10 w-full sm:w-auto">
            <Button size="lg" className="w-full sm:w-auto bg-[#C8A856] hover:bg-[#d4b566] text-black font-black rounded-full px-12 py-8 text-xl transition-transform hover:scale-105 shadow-[0_0_40px_rgba(200,168,86,0.3)]">
              Open Your Studio
            </Button>
          </Link>
        </div>
      ...
      <footer className="w-full border-t border-zinc-200 dark:border-white/5 py-12 text-center text-zinc-500 dark:text-zinc-600 text-sm bg-zinc-50 dark:bg-transparent relative z-20">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between px-6 gap-6">
          ...
          <p>© 2026 Backing & Score. Built for professional musicians.</p>
        </div>
      </footer>
    </div>
  );
